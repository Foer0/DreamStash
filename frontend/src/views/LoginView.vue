    ...
    <header class="auth-header">
      ...
      <div class="desktop-menu-container">
        ...
        <nav class="dropdown-menu-horizontal">
          <button class="nav-item" @click="router.push('/register')">SIGN UP</button>
    ...
    <main class="auth-main">
      ...
      <div class="auth-form">
        ...
        <p class="auth-switch">
          ...
          <span class="text-link" @click="router.push('/register')">Sign Up</span>
        </p>
...
async function handleLogin() {
  ...
  try {
    ...
    form.append('username', email.value.trim())
...
@media (min-width: 1024px) {
  ...
  .desktop-menu-container:hover .dropdown-menu-horizontal {
